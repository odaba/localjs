...
$doxygen_title = "LocalJS: LOCALIZATION类参考";
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="所有 LocalJS 基本对象的根对象。要使用 LocalJS 基本对象，在 HTML 页面里包含 LocalJS Open Source Library 中的 JavaScript 文件。...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="返回 LOCALIZATION 对象，它提供了多语言支持。需要包含 localjs_localization.js，localjs_file.js，localjs_ui.js 和 localjs_webservice.js。">LOCALIZATION</a>.setPath(<span class="stringliteral">&quot;path_to_language_folder&quot;</span>);
</pre></div> 
</div>
</div>
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="所有 LocalJS 基本对象的根对象。要使用 LocalJS 基本对象，在 HTML 页面里包含 LocalJS Open Source Library 中的 JavaScript 文件。...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="返回 LOCALIZATION 对象，它提供了多语言支持。需要包含 localjs_localization.js，localjs_file.js，localjs_ui.js 和 localjs_webservice.js。">LOCALIZATION</a>.setLang(<span class="stringliteral">&#39;cn&#39;</span>);
</pre></div> 
</div>
</div>
...
<div class="fragment"><pre class="fragment">    var localized_string = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="所有 LocalJS 基本对象的根对象。要使用 LocalJS 基本对象，在 HTML 页面里包含 LocalJS Open Source Library 中的 JavaScript 文件。...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="返回 LOCALIZATION 对象，它提供了多语言支持。需要包含 localjs_localization.js，localjs_file.js，localjs_ui.js 和 localjs_webservice.js。">LOCALIZATION</a>.get(<span class="stringliteral">&#39;year&#39;</span>); <span class="comment">// return &#39;年&#39; for langauge &#39;cn&#39;.</span>
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="所有 LocalJS 基本对象的根对象。要使用 LocalJS 基本对象，在 HTML 页面里包含 LocalJS Open Source Library 中的 JavaScript 文件。...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="返回 LOCALIZATION 对象，它提供了多语言支持。需要包含 localjs_localization.js，localjs_file.js，localjs_ui.js 和 localjs_webservice.js。">LOCALIZATION</a>.setLang(<span class="stringliteral">&#39;en&#39;</span>);
    var year_str = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="所有 LocalJS 基本对象的根对象。要使用 LocalJS 基本对象，在 HTML 页面里包含 LocalJS Open Source Library 中的 JavaScript 文件。...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="返回 LOCALIZATION 对象，它提供了多语言支持。需要包含 localjs_localization.js，localjs_file.js，localjs_ui.js 和 localjs_webservice.js。">LOCALIZATION</a>.get(<span class="stringliteral">&#39;year&#39;</span>); <span class="comment">// return &#39;year&#39; even if en.json doesn&#39;t include key &#39;year&#39;.</span>
...
<div class="fragment"><pre class="fragment">    var dt = <span class="keyword">new</span> Date();
    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="所有 LocalJS 基本对象的根对象。要使用 LocalJS 基本对象，在 HTML 页面里包含 LocalJS Open Source Library 中的 JavaScript 文件。...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="返回 LOCALIZATION 对象，它提供了多语言支持。需要包含 localjs_localization.js，localjs_file.js，localjs_ui.js 和 localjs_webservice.js。">LOCALIZATION</a>.setLang(<span class="stringliteral">&#39;cn&#39;</span>);
    var localized_date = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="所有 LocalJS 基本对象的根对象。要使用 LocalJS 基本对象，在 HTML 页面里包含 LocalJS Open Source Library 中的 JavaScript 文件。...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="返回 LOCALIZATION 对象，它提供了多语言支持。需要包含 localjs_localization.js，localjs_file.js，localjs_ui.js 和 localjs_webservice.js。">LOCALIZATION</a>.get(<span class="stringliteral">&#39;formatDate&#39;</span>)(dt);
</pre></div> 
</div>
</div>
...
<div class="fragment"><pre class="fragment">    var user_lang = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="所有 LocalJS 基本对象的根对象。要使用 LocalJS 基本对象，在 HTML 页面里包含 LocalJS Open Source Library 中的 JavaScript 文件。...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="返回 LOCALIZATION 对象，它提供了多语言支持。需要包含 localjs_localization.js，localjs_file.js，localjs_ui.js 和 localjs_webservice.js。">LOCALIZATION</a>.getAcceptLanguages(); <span class="comment">// return &#39;en-us,zh-CN;q=0.7,zh-HK;q=0.3&#39;</span>
</pre></div> 
</div>
</div>
</div>
