...
<div class="fragment"><pre class="fragment">    var onOK = function (responseText, objHttp)
    ...
    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="所有 LocalJS 基本对象的根对象。要使用 LocalJS 基本对象，在 HTML 页面里包含 LocalJS Open Source Library 中的 JavaScript 文件。...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a93d1c0c70becb07c74e108b0f1bd49d6" title="返回 WEB_SERVICE 对象，它提供了调用 web 服务的方法。需要包含 localjs_webservice.js。">WEB_SERVICE</a>.callUrl(<span class="stringliteral">&quot;GET&quot;</span>, <span class="stringliteral">&quot;http://localjs.org/demo/demo_ws.php&quot;</span>, { <span class="stringliteral">&#39;ok&#39;</span> : onOK, <span class="stringliteral">&#39;fail&#39;</span> : onFail });
