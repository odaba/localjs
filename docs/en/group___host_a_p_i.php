...
$doxygen_title = "LocalJS: LocalJS Host API";
...
<dl class="attention"><dt><b>Attention:</b></dt><dd><em>DO NOT call <a class="el" href="group___host_a_p_i.php#gac45d62dc3eb89dfd8715187967f9ccd5" title="Uninitialize LocalJS, free resources taken. DO NOT call from DllMain.">uninitializeLocalJS()</a> from <a href="http://msdn.microsoft.com/en-us/library/ms682583(VS.85).aspx" target="_blank">DllMain</a>.</em> Function <a class="el" href="group___host_a_p_i.php#ga2bda3d0035edca22e5fd7d3cbca3fa03" title="Initialize LocalJS. DO NOT call from DllMain.">initializeLocalJS()</a> calls <a href="http://msdn.microsoft.com/en-us/library/ms688715(VS.85).aspx" target="_blank">CoUninitialize Function</a>, which should not be called in <a href="http://msdn.microsoft.com/en-us/library/ms682583(VS.85).aspx" target="_blank">DllMain</a> according to MSDN.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="group___host_a_p_i.php#ga2bda3d0035edca22e5fd7d3cbca3fa03" title="Initialize LocalJS. DO NOT call from DllMain.">initializeLocalJS()</a> | <a href="http://msdn.microsoft.com/en-us/library/ms682583(VS.85).aspx" target="_blank">DllMain Callback Function</a> </dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>A handle to the Internet Explorer created. The handle <em>MUST</em> be passed to <a class="el" href="group___host_a_p_i.php#ga314b0a2593ed6d4c12248d2068082158" title="Free the browser window handle retuned by createBrowserWindow() or createIE()">deleteBrowserWindow()</a> to be freed.</dd></dl>
...
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="group___host_a_p_i.php#ga1ca250104d8e424d1af1fae979bea9d6" title="Launch a LocalJS browser window.">createBrowserWindow()</a> | <a class="el" href="group___host_a_p_i.php#ga392ee050a9bb4f8bc3a549498f2491c2" title="Launch a LocalJS standalone Internet Explorer application.">createIE()</a> | <a class="el" href="group___host_a_p_i.php#gac47c4be12c58fe280e658329f798c141" title="Detach the browser window handle from the underlying LocalJS browser window or Internet Explorer appl...">detachBrowserWindow()</a> </dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd><code>TRUE</code> if the underlying LocalJS browser window or Internet Explorer has been closed, <code>FALSE</code> otherwise</dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The <code>HWND</code> handle of current browser window. For Internet Explorer 7 and above, it's the main window of the Internet Explorer application, not the tab window of the page. Returns zero for detached browser window handle.</dd></dl>
<dl class="note"><dt><b>Note:</b></dt><dd><a class="el" href="group___host_a_p_i.php#ga8d6df87cf800c5be2e7be541b34c1317" title="Returns the HWND handle to LocalJS browser window or Internet Explorer application.">getBrowserHostWnd()</a> returns same value as <a class="el" href="interfacelocal_j_s.php#aa05066bf1c7f31ea898c0d2aed29eedb" title="ReadOnly. Returns the HWND handle of current browser window.">localJS.hostWnd</a>.</dd></dl>
...
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="group___host_a_p_i.php#ga1ca250104d8e424d1af1fae979bea9d6" title="Launch a LocalJS browser window.">createBrowserWindow()</a> | <a class="el" href="group___host_a_p_i.php#ga392ee050a9bb4f8bc3a549498f2491c2" title="Launch a LocalJS standalone Internet Explorer application.">createIE()</a> | <a class="el" href="interfacelocal_j_s.php#aa05066bf1c7f31ea898c0d2aed29eedb" title="ReadOnly. Returns the HWND handle of current browser window.">localJS.hostWnd</a> </dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The <code>HWND</code> handle of current browser window tab. Returns zero for detached browser window handle. <em>ONLY</em> apply to Internet Explorer 7 and above.</dd></dl>
...
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="group___host_a_p_i.php#ga392ee050a9bb4f8bc3a549498f2491c2" title="Launch a LocalJS standalone Internet Explorer application.">createIE()</a> | <a class="el" href="group___host_a_p_i.php#ga8d6df87cf800c5be2e7be541b34c1317" title="Returns the HWND handle to LocalJS browser window or Internet Explorer application.">getBrowserHostWnd()</a> | <a class="el" href="interfacelocal_j_s.php#a231aa00f34826cb7baf3d21ca25cc2cc" title="ReadOnly. Returns the HWND handle of current browser window tab. ONLY apply to Internet Explorer 7 an...">localJS.IETabWnd</a> </dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The underlying LocalJS browser window type. <ul>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The WebBrowser object of underlying LocalJS browser window or Internet Explorer. NULL for detached browser window handle.</dd></dl>
...
<dl class="note"><dt><b>Note:</b></dt><dd><a class="el" href="group___host_a_p_i.php#gad71e54ddf1d1fad062c95a5c9b574806" title="Returns the WebBrowser object of underlying LocalJS browser window or Internet Explorer.">getBrowserObj()</a> calls <a href="http://msdn.microsoft.com/en-us/library/ms691379(VS.85).aspx" target="_blank">AddRef</a> on the returned IDispatch * pointer.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="group___host_a_p_i.php#ga1ca250104d8e424d1af1fae979bea9d6" title="Launch a LocalJS browser window.">createBrowserWindow()</a> | <a class="el" href="interface_c_o_m.php#a9742cc74cdf0445008d4adb2adbaa0d3" title="Convert a raw IDispatch * pointer to an object usable in JavaScript.">COM.interface2Object</a> | <a href="http://msdn.microsoft.com/en-us/library/ms691379(VS.85).aspx" target="_blank">AddRef</a> </dd></dl>
...
<dl class="note"><dt><b>Note:</b></dt><dd><a class="el" href="group___host_a_p_i.php#ga779ed3a959cb0e21f8aad4b899bdb505" title="Call JavaScript function by C style function prototype, passing variable number of arguments...">callJSFunction()</a> internally calls <a class="el" href="group___host_a_p_i.php#ga1cd8332c156b5897050189b2250dca2e" title="Call JavaScript function by C style function prototype, passing variable number of arguments in one v...">callJSFunction_va_list()</a> for implementation:</dd></dl>
...
</pre></div><dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="group___host_a_p_i.php#ga1cd8332c156b5897050189b2250dca2e" title="Call JavaScript function by C style function prototype, passing variable number of arguments in one v...">callJSFunction_va_list()</a> </dd></dl>
...
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="group___host_a_p_i.php#ga779ed3a959cb0e21f8aad4b899bdb505" title="Call JavaScript function by C style function prototype, passing variable number of arguments...">callJSFunction()</a> </dd></dl>
