...
<div class="contents">
<div align="center"><em>Prev:</em> <a class="el" href="getting_started.php">Getting Started</a> | <em>Next:</em> <a class="el" href="tutorial_js4cpp.php">JavaScript Jump Start For C++ Programmers</a> | <a class="el" href="group___j_s_objects.php">LocalJS Objects (Advanced)</a> | <a class="el" href="index.php">Document Home</a> | <a href="http://sourceforge.net/projects/localjs/files/" target="_blank">Download demo application</a></div><p>Quick jump link:</p>
<p><a class="el" href="howto.php#howto_start_up">LocalJS Start Up</a> </p>
<ul>
<li><a class="el" href="howto.php#howto_start_local_js">How to start a LocalJS application?</a> </li>
...
<p><a class="el" href="howto.php#howto_browser_wnd">Play with Browser Window</a> </p>
<ul>
<li><a class="el" href="howto.php#howto_move_wnd">How to move browser window around on desktop within JavaScript?</a> </li>
<li><a class="el" href="howto.php#howto_change_wnd_style">How to change browser window style (borders, title bars, etc) within JavaScript?</a> </li>
<li><a class="el" href="howto.php#howto_popup_msg">How to popup a message dialog better than JavaScript alert?</a> </li>
...
<p><a class="el" href="howto.php#howto_file_access">Folders and Files</a> </p>
<ul>
...
<p><a class="el" href="howto.php#howto_navigation">Navigate Back and Forth</a> </p>
<ul>
...
<p><a class="el" href="howto.php#howto_new_wnd">Launching New Browser Window</a> </p>
<ul>
...
<li><a class="el" href="howto.php#howto_interop_other_wnd">How to interop with JavaScript in other LocalJS browser window?</a> </li>
...
<p><a class="el" href="howto.php#howto_db">Database</a> </p>
<ul>
<li><a class="el" href="howto.php#howto_access_db">How to access database?</a></li>
</ul>
<p><a class="el" href="howto.php#howto_web_service">Call Web Service from any domain</a> </p>
<ul>
...
<p><a class="el" href="howto.php#howto_sys_info">Retrieve System Information</a> </p>
<ul>
...
<p><a class="el" href="howto.php#howto_thread">Multithreading</a> </p>
<ul>
...
<p>Refer to <em>Detailed</em> <em>Section</em> of <a class="el" href="group___host_a_p_i.php">LocalJS Hosting API</a> for diagram and pseudo code illustrating the workflow.</p>
...
<ul>
<li>Retrive window handle with <a class="el" href="interfacelocal_j_s.php#aa05066bf1c7f31ea898c0d2aed29eedb" title="ReadOnly. Returns the HWND handle of current browser window.">localJS.hostWnd</a>; </li>
<li>Call Windows API <a href="http://msdn.microsoft.com/en-us/library/ms633534(VS.85).aspx" target="_blank">MoveWindow</a> with <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object.</li>
</ul>
<p>Refer to <a class="el" href="interfacelocal_j_s.php#a3566d4b69cb659d2e22501a77bc5af32" title="ReadOnly. Returns the height of the bottom localJS bar in pixels.">localJS.btmBarHeight</a> for sample code.</p>
...
<div class="fragment"><pre class="fragment">    var dllCall = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&quot;DllCall&quot;</span>),
        ...
        hostWnd = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#aa05066bf1c7f31ea898c0d2aed29eedb" title="ReadOnly. Returns the HWND handle of current browser window.">hostWnd</a>;
...
<ul>
<li>Retrive window handle with <a class="el" href="interfacelocal_j_s.php#aa05066bf1c7f31ea898c0d2aed29eedb" title="ReadOnly. Returns the HWND handle of current browser window.">localJS.hostWnd</a>; </li>
<li>Call Windows API <a href="http://msdn.microsoft.com/en-us/library/ms645505(VS.85).aspx" target="_blank">MessageBox</a> with <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object. </li>
<li>Alternatively, simply use HTML dialog provided by JavaScript libraries, which is much nicer and more controlable.</li>
</ul>
<p>Refer to <em>Detailed</em> <em>Description</em> of <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object for sample code.</p>
...
<ul>
<li>Call method <a class="el" href="interfacelocal_j_s.php#ae0a273e38f45d2547157ddb6cfa6108c" title="Close the current browser window. NOT available in standalone Internet Explorer application.">localJS.closeWindow</a> to close browser window from with JavaScript.</li>
</ul>
...
<ul>
<li>Get <code>WebBrowser</code> object of current browser through property <a class="el" href="interfacelocal_j_s.php#a426d92f4370abff654c9a85a060c25c9" title="Readonly. Returns WebBrowser Object of current browser. Help transparently moving forth and back betw...">localJS.webBrowser</a>. </li>
<li>Use <a class="el" href="interface_c_o_m.php#a03b548ce8da020a692d590d4a5b21247" title="Connect JavaScript functions to COM object events.">COM.connectEvents</a> to hook <code>WindowClosing</code> event fired by <code>WebBrowser</code> object.</li>
</ul>
<dl class="user"><dt><b></b></dt><dd>Refer to <a class="el" href="interfacelocal_j_s.php#ae0a273e38f45d2547157ddb6cfa6108c" title="Close the current browser window. NOT available in standalone Internet Explorer application.">localJS.closeWindow</a> for sample code.</dd></dl>
<p>To catch close window action from user: </p>
<ul>
<li>Get <code>HWND</code> handle to current browser window through property <a class="el" href="interfacelocal_j_s.php#aa05066bf1c7f31ea898c0d2aed29eedb" title="ReadOnly. Returns the HWND handle of current browser window.">localJS.hostWnd</a>. </li>
<li>Use <a class="el" href="interface_window_hook.php" title="Hook messages of the specified window.">WindowHook</a> object to hook <code>WM_CLOSE</code> message of <a class="el" href="interfacelocal_j_s.php#aa05066bf1c7f31ea898c0d2aed29eedb" title="ReadOnly. Returns the HWND handle of current browser window.">localJS.hostWnd</a></li>
</ul>
<dl class="user"><dt><b></b></dt><dd>Refer to <em>Detailed</em> <em>Description</em> of <a class="el" href="interface_window_hook.php" title="Hook messages of the specified window.">WindowHook</a> object for sample code.</dd></dl>
...
<ul>
<li>Create <a href="http://msdn.microsoft.com/en-us/library/bb774094(VS.85).aspx" target="_blank">Shell Object</a> with method <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>; </li>
...
<p>Refer to <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a> for an example.</p>
<h3><a class="anchor" id="howto_create_folder"></a>
How to create folder in disk?</h3>
<ul>
<li>Create <a href="http://msdn.microsoft.com/en-us/library/6kxy1a51(VS.85).aspx" target="_blank">FileSystemObject</a> with method <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>; </li>
...
<li>
Create <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object with <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>; </li>
<li>
Call Windows API <a href="http://msdn.microsoft.com/en-us/library/ms724353(VS.85).aspx" target="_blank">GetPrivateProfileString</a>, <a href="http://msdn.microsoft.com/en-us/library/ms724345(VS.85).aspx" target="_blank">GetPrivateProfileInt</a> and <a href="http://msdn.microsoft.com/en-us/library/ms725501(VS.85).aspx" target="_blank">WritePrivateProfileString</a> using <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object: </li>
</ul>
</li>
</ul>
<div class="fragment"><pre class="fragment">    var dllCall = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&quot;DllCall&quot;</span>);
...
<div class="fragment"><pre class="fragment">    var fso = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&quot;Scripting.FileSystemObject&quot;</span>),
    ...
    f.Close();
</pre></div><dl class="user"><dt><b></b></dt><dd>Refer to <a class="el" href="interface_threading.php#ab83b569dcb6b1ed35d6e9f13a8376a64" title="Create new script thread with optional arguments. Returns Thread object represents the new thread...">Threading.newThread</a> for sample code reading text file with <a href="http://msdn.microsoft.com/en-us/library/6kxy1a51(VS.85).aspx" target="_blank">FileSystemObject</a>.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_dll_call.php#ab6730ea57a7678c1f07953ce331edca0" title="Add function exported by DLL or EXE file as a method of current DllCall object.">DllCall.add</a> | <a class="el" href="interface_dll_call.php#af9c99ab123bbf569e623a9c5e5c9f40e" title="Create a Buffer object, optionaly initialized it to given value.">DllCall.newBuffer</a> | <a class="el" href="interface_buffer.php" title="Buffer object represents a fixed size buffer, used as parameters in Dll function call.">Buffer</a> | <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a></dd></dl>
<h3><a class="anchor" id="howto_save_2_reg"></a>
How to save settings to registry?</h3>
<ul>
<li>Create <a href="http://msdn.microsoft.com/en-us/library/aew9yb99(VS.85).aspx" target="_blank">WshShell Object</a> with <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>:</li>
</ul>
<div class="fragment"><pre class="fragment">    var shell = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&quot;WScript.Shell&quot;</span>);
...
<ul>
<li>Create <a href="http://msdn.microsoft.com/en-us/library/ms675032(VS.85).aspx" target="_blank">Stream Object (ADO)</a> with <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>; </li>
...
<div class="fragment"><pre class="fragment">    var objStream = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&quot;ADODB.Stream&quot;</span>);
    ...
    objStream.Close();
</pre></div><p>Refer to <a class="el" href="interface_threading.php#ab83b569dcb6b1ed35d6e9f13a8376a64" title="Create new script thread with optional arguments. Returns Thread object represents the new thread...">Threading.newThread</a> for sample code reading utf-8 format file.</p>
<h3><a class="anchor" id="howto_browse_file"></a>
How to browse for a file?</h3>
<ul>
<li>Create <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object through <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>; </li>
<li>Call Windows API <a href="http://msdn.microsoft.com/en-us/library/ms646927(VS.85).aspx" target="_blank">GetOpenFileName</a> with <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object.</li>
</ul>
...
<ul>
<li>Create <a class="el" href="interface_structure.php" title="Structure object represents a C struct, used as parameters in Dll function call.">Structure</a> object with <a class="el" href="interface_dll_call.php#ac5fb73dfc65171de9e56b090a56b1269" title="Create an empty Structure object.">DllCall.newStruct</a> method; </li>
<li>Filling fields in with methods <a class="el" href="interface_structure.php#a0ce42643bb28edae3ef95829c7257d18" title="Append field to Structure object, optionally specify field name.">Structure.add</a>, <a class="el" href="interface_structure.php#a9281de28bee204692288a33173e38568" title="Append a 4 bytes field to Structure object, optionally specify initial value and field name...">Structure.addLong</a> and <a class="el" href="interface_structure.php#add3df9b88b7ecc45ee30cd9969020c28" title="Append a 2 bytes field to Structure object, optionally specify initial value and field name...">Structure.addShort</a> to represent <a href="http://msdn.microsoft.com/en-us/library/ms646839(VS.85).aspx" target="_blank">OPENFILENAME</a>. <dl class="user"><dt><b></b></dt><dd>For field members who are buffers, add a <a class="el" href="interface_buffer.php" title="Buffer object represents a fixed size buffer, used as parameters in Dll function call.">Buffer</a> object created by <a class="el" href="interface_dll_call.php#af9c99ab123bbf569e623a9c5e5c9f40e" title="Create a Buffer object, optionaly initialized it to given value.">DllCall.newBuffer</a>. </dd></dl>
</li>
<li>Pass the <a class="el" href="interface_structure.php" title="Structure object represents a C struct, used as parameters in Dll function call.">Structure</a> object to <a href="http://msdn.microsoft.com/en-us/library/ms646927(VS.85).aspx" target="_blank">GetOpenFileName</a> through <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object.</li>
</ul>
<p>Refer to <a class="el" href="interface_structure.php#a0ce42643bb28edae3ef95829c7257d18" title="Append field to Structure object, optionally specify field name.">Structure.add</a> for the example code. It's a bit long because <a href="http://msdn.microsoft.com/en-us/library/ms646839(VS.85).aspx" target="_blank">OPENFILENAME</a> is a big structure.</p>
...
<div class="fragment"><pre class="fragment">    var shellApp = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&quot;Shell.Application&quot;</span>),
        retVal = shellApp.BrowseForFolder(<a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#aa05066bf1c7f31ea898c0d2aed29eedb" title="ReadOnly. Returns the HWND handle of current browser window.">hostWnd</a>, <span class="stringliteral">&quot;Title&quot;</span>, 0);
...
<ul>
<li>Save parameters to <a class="el" href="interfacelocal_j_s.php#ae46e48b1edd261d9c6fc8a9116ae564d" title="ReadOnly. Returns a Dictionary Object associated with current browser window. An ideal persistent sto...">localJS.browserDict</a> so the next page can access it.</li>
</ul>
<p>Refer to <a class="el" href="interfacelocal_j_s.php#ae46e48b1edd261d9c6fc8a9116ae564d" title="ReadOnly. Returns a Dictionary Object associated with current browser window. An ideal persistent sto...">localJS.browserDict</a> for an example.</p>
...
<ul>
<li>Use <a class="el" href="interfacelocal_j_s.php#ae46e48b1edd261d9c6fc8a9116ae564d" title="ReadOnly. Returns a Dictionary Object associated with current browser window. An ideal persistent sto...">localJS.browserDict</a> to prevent data from lost when page is reloaded:</li>
</ul>
<div class="fragment"><pre class="fragment">    var persist_data;

    window.attachEvent(<span class="stringliteral">&quot;onload&quot;</span>, function()
    {
        var browserDict = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ae46e48b1edd261d9c6fc8a9116ae564d" title="ReadOnly. Returns a Dictionary Object associated with current browser window. An ideal persistent sto...">browserDict</a>;
...
<p>Even with <a class="el" href="interfacelocal_j_s.php#ae46e48b1edd261d9c6fc8a9116ae564d" title="ReadOnly. Returns a Dictionary Object associated with current browser window. An ideal persistent sto...">localJS.browserDict</a>, it's still boring to handle unexpected page reloading caused by user pressing F5 key.</p>
<ul>
...
<p>Refer to <a class="el" href="interfacelocal_j_s.php#a29a79e553fe87184f3a6ed6a9e0b270f" title="Get or set a boolean value to control whether pressing F5 key reloads HTML page. Ignored by standalon...">localJS.enableF5</a>.</p>
...
<ul>
<li>Create <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object through <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>; </li>
<li>Call <a class="el" href="group___host_a_p_i.php">LocalJS Hosting API</a> <a class="el" href="group___host_a_p_i.php#ga1ca250104d8e424d1af1fae979bea9d6" title="Launch a LocalJS browser window.">createBrowserWindow()</a> function through <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object.</li>
</ul>
<p>Refer to <a class="el" href="group___host_a_p_i.php#ga1ca250104d8e424d1af1fae979bea9d6" title="Launch a LocalJS browser window.">createBrowserWindow()</a> for an example.</p>
<h3><a class="anchor" id="howto_new_wnd_by_click"></a>
How to launch a new LocalJS browser window when user clicks a link?</h3>
<ul>
<li>Get <code>WebBrowser</code> object of current browser through property <a class="el" href="interfacelocal_j_s.php#a426d92f4370abff654c9a85a060c25c9" title="Readonly. Returns WebBrowser Object of current browser. Help transparently moving forth and back betw...">localJS.webBrowser</a>; </li>
<li>Connect to <a href="http://msdn.microsoft.com/en-us/library/aa768337(VS.85).aspx" target="_blank">NewWindow3 event</a> of the <code>WebBrowser</code> object with <a class="el" href="interface_c_o_m.php#a03b548ce8da020a692d590d4a5b21247" title="Connect JavaScript functions to COM object events.">COM.connectEvents</a>; </li>
<li>Set <code>disp.returnValue</code> to the <code>WebBrowser</code> object of a new created browser window.</li>
</ul>
<p>Refer to <a class="el" href="interface_c_o_m.php#a03b548ce8da020a692d590d4a5b21247" title="Connect JavaScript functions to COM object events.">COM.connectEvents</a> for an example of handling <a href="http://msdn.microsoft.com/en-us/library/aa768337(VS.85).aspx" target="_blank">NewWindow3 event</a>.</p>
<dl class="note"><dt><b>Note:</b></dt><dd>The <code>WebBrowser</code> object of new created browser window is retrieved through function <a class="el" href="group___host_a_p_i.php#gad71e54ddf1d1fad062c95a5c9b574806" title="Returns the WebBrowser object of underlying LocalJS browser window or Internet Explorer.">getBrowserObj()</a> and <a class="el" href="interface_c_o_m.php#a9742cc74cdf0445008d4adb2adbaa0d3" title="Convert a raw IDispatch * pointer to an object usable in JavaScript.">COM.interface2Object</a>. </dd></dl>
<dl class="user"><dt><b></b></dt><dd>Refer to <a class="el" href="group___host_a_p_i.php#ga1ca250104d8e424d1af1fae979bea9d6" title="Launch a LocalJS browser window.">createBrowserWindow()</a> for an example showing how to get the <code>WebBrowser</code> object of new created browser window.</dd></dl>
<h3><a class="anchor" id="howto_interop_other_wnd"></a>
How to interop with JavaScript in other LocalJS browser window?</h3>
<ul>
<li>Get the <code>WebBrowser</code> object of new created browser window through function <a class="el" href="group___host_a_p_i.php#gad71e54ddf1d1fad062c95a5c9b574806" title="Returns the WebBrowser object of underlying LocalJS browser window or Internet Explorer.">getBrowserObj()</a> and <a class="el" href="interface_c_o_m.php#a9742cc74cdf0445008d4adb2adbaa0d3" title="Convert a raw IDispatch * pointer to an object usable in JavaScript.">COM.interface2Object</a>. </li>
...
<p>Refer to <a class="el" href="group___host_a_p_i.php#ga1ca250104d8e424d1af1fae979bea9d6" title="Launch a LocalJS browser window.">createBrowserWindow()</a> for example code.</p>
...
<p>Refer to <a class="el" href="interfacelocal_j_s.php#a3db8e9f0672a2aed8a468da67db3b2e1" title="ReadOnly. Returns a Dictionary Object globally available in the process. An ideal global persistent s...">localJS.globalDict</a> for an example.</p>
<h3><a class="anchor" id="howto_shell_exec"></a>
How to open a url in system default browser?</h3>
<ul>
<li>Create <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object with <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>; </li>
<li>Call <a href="http://msdn.microsoft.com/en-us/library/bb762153(VS.85).aspx" target="_blank">ShellExecute function</a> with <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object:</li>
</ul>
<div class="fragment"><pre class="fragment">    var dllCall = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&#39;DllCall&#39;</span>);
...
<ul>
<li>Create <a href="http://msdn.microsoft.com/en-us/library/ms535874(VS.85).aspx" target="_blank">XMLHttpRequest object</a> with <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>; </li>
...
<div class="fragment"><pre class="fragment">    var oHttp = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&quot;Microsoft.XMLHTTP&quot;</span>);
...
Create <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object with <a class="el" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">COM.createObject</a>; </li>
<li>
Call <a href="http://msdn.microsoft.com/en-us/library/ms683197(VS.85).aspx" target="_blank">GetModuleFileName function</a> through <a class="el" href="interface_dll_call.php" title="DllCall object enables JavaScript call functions exported by DLL or EXE files, including most Windows...">DllCall</a> object. <dl class="user"><dt><b></b></dt><dd>For parameter <em>lpFilename</em> of <a href="http://msdn.microsoft.com/en-us/library/ms683197(VS.85).aspx" target="_blank">GetModuleFileName function</a>, pass with a <a class="el" href="interface_buffer.php" title="Buffer object represents a fixed size buffer, used as parameters in Dll function call.">Buffer</a> object created with <a class="el" href="interface_dll_call.php#af9c99ab123bbf569e623a9c5e5c9f40e" title="Create a Buffer object, optionaly initialized it to given value.">DllCall.newBuffer</a> method. </dd></dl>
</li>
</ul>
<p>Refer to <a class="el" href="interface_dll_call.php#af9c99ab123bbf569e623a9c5e5c9f40e" title="Create a Buffer object, optionaly initialized it to given value.">DllCall.newBuffer</a> for an example.</p>
...
<p>Refer to <a class="el" href="howto.php#howto_enum_file">How to enumerate files in a folder?</a></p>
...
<p>Refer to <a class="el" href="interface_threading.php#ab83b569dcb6b1ed35d6e9f13a8376a64" title="Create new script thread with optional arguments. Returns Thread object represents the new thread...">Threading.newThread</a> for an example.</p>
...
<p>Refer to <a class="el" href="interface_thread.php#a2bb58b88ac256b165a95a806ae3b41e5" title="ReadOnly. Returns true if the thread is running, false if the thread has ended.">Thread.running</a> for an example;</p>
