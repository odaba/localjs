...
$doxygen_title = "LocalJS: Threading Class Reference";
...
<h3> <a id="synchronization"></a>  Thread Synchronization</h3>
...
<dl class="return"><dt><b>Returns:</b></dt><dd><code>true</code> if current thread is told to end, <code>false</code> otherwise.</dd></dl>
...
<dl class="note"><dt><b>Note:</b></dt><dd>Property <a class="el" href="interface_threading.php#aef5e9b75a775657e77890df94dca043a">ending</a> is only available inside a new created script thread. It's not available in the JavaScript run inside browser.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_thread.php#a21571c3d25402f70379cfa4facaf8dfa" title="Forcely terminate the thread.">Thread.kill</a> </dd></dl>
