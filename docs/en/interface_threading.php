...
</pre></div><p>Obviously simple thread as above is not very useful. In most cases, script for new thread are saved in disk files. Following function returns content of the file with <a href="http://msdn.microsoft.com/en-us/library/t58aa4dd(VS.85).aspx" target="_blank">ReadAll Method</a> of <a href="http://msdn.microsoft.com/en-us/library/312a5kbt(VS.85).aspx" target="_blank">TextStream Object</a>:</p>
<div class="fragment"><pre class="fragment">    var fnReadFile = function(file_name)
    {
        var fso = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&quot;Scripting.FileSystemObject&quot;</span>),
            f = fso.OpenTextFile(file_name);

        <span class="keywordflow">if</span> (f.AtEndOfStream)
            <span class="keywordflow">return</span> <span class="stringliteral">&quot;&quot;</span>;
        <span class="keywordflow">else</span>
            <span class="keywordflow">return</span> f.ReadAll();
    };
</pre></div><p>One limitation of <a href="http://msdn.microsoft.com/en-us/library/6kxy1a51(VS.85).aspx" target="_blank">FileSystemObject</a> is it can only read files in either ANSI or utf-16 format: it will fail to read utf-8 format file correctly. For utf-8 format file, read with <a href="http://msdn.microsoft.com/en-us/library/ms675032(VS.85).aspx" target="_blank">Stream Object (ADO)</a> instead:</p>
<div class="fragment"><pre class="fragment">    var fnReadUTF8File = function(file_name)
    {
        var objStream = <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac46dd82aca231ab33f6308ba12975594" title="Readonly. Returns object COM, which exposes methods to create COM object, connect COM events...">COM</a>.<a class="code" href="interface_c_o_m.php#a14285e3676c39b414cac2652046ec881" title="Create COM object by ProgID, optionally specify object location.">createObject</a>(<span class="stringliteral">&quot;ADODB.Stream&quot;</span>);

        objStream.Open();
        objStream.Charset = <span class="stringliteral">&quot;utf-8&quot;</span>;
        objStream.LoadFromFile(file_name);
        var result = objStream.ReadText();
        objStream.Close();

        <span class="keywordflow">return</span> result;
    };
</pre></div><dl class="see"><dt><b>See also:</b></dt><dd><a href="http://msdn.microsoft.com/en-us/library/6kxy1a51(VS.85).aspx" target="_blank">FileSystemObject</a> | <a href="http://msdn.microsoft.com/en-us/library/312a5kbt(VS.85).aspx" target="_blank">TextStream Object</a> | <a href="http://msdn.microsoft.com/en-us/library/t58aa4dd(VS.85).aspx" target="_blank">ReadAll Method</a> | <a href="http://msdn.microsoft.com/en-us/library/ms675032(VS.85).aspx" target="_blank">Stream Object (ADO)</a></dd></dl>
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac12d811a674c6cc7417b6f9a8d39736c" title="Readonly. Returns object Threading, which exposes methods to create new script thread, sleep, get thread id, etc.">threading</a>.<a class="code" href="interface_threading.php#ab83b569dcb6b1ed35d6e9f13a8376a64" title="Create new script thread with optional arguments. Returns Thread object represents the new thread...">newThread</a>(fnReadFile(<span class="stringliteral">&quot;c:\\script_thread.js&quot;</span>), [val1, val2, val3]);
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#ac12d811a674c6cc7417b6f9a8d39736c" title="Readonly. Returns object Threading, which exposes methods to create new script thread, sleep, get thread id, etc.">threading</a>.<a class="code" href="interface_threading.php#ab83b569dcb6b1ed35d6e9f13a8376a64" title="Create new script thread with optional arguments. Returns Thread object represents the new thread...">newThread</a>(fnReadFile(<span class="stringliteral">&quot;c:\\script_thread.js&quot;</span>), {<span class="stringliteral">&#39;arg1&#39;</span> : val1, <span class="stringliteral">&#39;arg2&#39;</span> : val2, <span class="stringliteral">&#39;arg3&#39;</span> : val3]);
