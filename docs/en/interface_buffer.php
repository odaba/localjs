...
$doxygen_title = "LocalJS: Buffer Class Reference";
include_once($base_path.'/_include/common_header_part1.php');
?>
<title>LocalJS: Buffer Class Reference</title>
...
<p><a href="class_buffer-members.php">List of all members.</a></p>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>new <a class="el" href="interface_buffer.php" title="Buffer object represents a fixed size buffer, used as parameters in Dll function call.">Buffer</a> object cloned.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_structure.php#aa993855d0ffaf23f5d40f784cadc4ee0" title="Returns a new Structure object having same content.">Structure.clone</a> </dd></dl>
...
</pre></div><dl class="attention"><dt><b>Attention:</b></dt><dd><em>DO</em> <em>NOT</em> use same <a class="el" href="interface_buffer.php" title="Buffer object represents a fixed size buffer, used as parameters in Dll function call.">Buffer</a> object for both ANSI and UNICODE string operations unless you know what you are doing.</dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The size of the buffer in bytes.</dd></dl>
<dl class="note"><dt><b>Note:</b></dt><dd>String length (or string buffer size) in most Windows API are counted by characters, not by bytes. Since <a class="el" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a> uses UNICODE string (each single character takes 2 bytes) by default, when pass buffer as string to Windows API, unless ANSI string is explicitly used, remember the buffer size passed to Windows API should be <code>buffer.size / 2</code>, or <code>buffer.size &gt;&gt; 1</code>.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_structure.php#a37363161b41c4165b98cba7abc7a9d95" title="ReadOnly. Returns the size of the structure (represented by the Structure object) in bytes...">Structure.size</a> </dd></dl>
