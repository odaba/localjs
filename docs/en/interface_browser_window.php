...
<title>LocalJS: BrowserWindow Class Reference</title>
...
<h1>BrowserWindow Class Reference<br/>
<small>
...
<p><a href="class_browser_window-members.php">List of all members.</a></p>
...
<div class="fragment"><pre class="fragment">    var browser_window = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.newWindow(<span class="stringliteral">&quot;http://example.com/exampleApp/&quot;</span>),
...
</pre></div><dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_browser_window.php#ad2d8da20a97eb156c4c54ae708c6a389" title="Returns the JavaScript window object of the browser window.">BrowserWindow.getJSWindow</a> </dd></dl>
...
<dl class="note"><dt><b>Note:</b></dt><dd>To get a notification when the browser window is closed, hook the <code>onunload</code> event of the <a href="http://www.javascriptkit.com/jsref/window.shtml" target="_blank">window object</a> of the browser page.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_browser_window.php#aa69c8bf1f1dcf4e72552efff1fe3e87e" title="Close the browser window.">BrowserWindow.close</a> | <a class="el" href="interface_browser_window.php#ad2d8da20a97eb156c4c54ae708c6a389" title="Returns the JavaScript window object of the browser window.">BrowserWindow.getJSWindow</a> | <a href="http://www.javascriptkit.com/jsref/window.shtml" target="_blank">window object</a> </dd></dl>
...
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_browser_window.php#a4bc7c90e1f4048197bac2c5ff797e9be" title="Returns true if the browser window is closed, false otherwise.">BrowserWindow.isClosed</a> </dd></dl>
...
<dl class="note"><dt><b>Note:</b></dt><dd>For LocalJS Internet Explorer, it's the handle to the main window of Internet Explorer, not to the tab window of the page.</dd></dl>
...
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_u_i.php#a862ffbf6976d63755adc1fc78f1a0354" title="Returns true if current page is loaded by standalone Internet Explorer, false if by LocalJS browser w...">UI.isIE</a> </dd></dl>
