...
<title>LocalJS: FILE Class Reference</title>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The value read from registry.</dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd><code>true</code> if a specified file exists; <code>false</code> if it does not.</dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd><code>true</code> if a specified folder exists; <code>false</code> if it does not.</dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>A string containing the name of the parent folder of the last component in a specified path.</dd></dl>
<p>The following code illustrates how to use the getParentFolder method:</p>
<div class="fragment"><pre class="fragment">    var parent_folder = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a49ca3d2aae1b4847965178deb5633261" title="Returns FILE object, which provides methods for common file and registry operations. Include localjs_file.js, localjs_ui.js and localjs_webservice.js to use it.">FILE</a>.getParentFolder(<span class="stringliteral">&quot;C:\\Program Files\\LocalJS&quot;</span>); <span class="comment">// return C:\Program Files</span>
</pre></div><dl class="note"><dt><b>Note:</b></dt><dd>The getParentFolder method works only on the provided path string. It does not attempt to resolve the path, nor does it check for the existence of the specified path. </dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The path to the selected folder, false if user cancels the dialog, or "" if user doesn't select a file system folder (for example, "My Computer"). Use <code>false</code> <code>===</code> to check if the dialog is canceled.</dd></dl>
<p>The following code illustrates how to use the browseFolder method:</p>
<div class="fragment"><pre class="fragment">    var folder = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a49ca3d2aae1b4847965178deb5633261" title="Returns FILE object, which provides methods for common file and registry operations. Include localjs_file.js, localjs_ui.js and localjs_webservice.js to use it.">FILE</a>.browseFolder(<span class="stringliteral">&quot;Please choose a folder&quot;</span>);
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The local file path from the url, or <code>false</code> if fails to convert. Use <code>false</code> <code>===</code> to check if the convert fails.</dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd><code>true</code> if the url given is a file system url, <code>false</code> if it's not.</dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The combined url, or <code>false</code> if the parameters are incorrect.</dd></dl>
