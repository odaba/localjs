...
<div class="contents">
<div align="center"><em>Prev:</em> <a class="el" href="howto.php">How To ...</a> | <em>Next:</em> <a class="el" href="tutorials.php">JavaScript Tutorials</a> | <a class="el" href="index.php">Document Home</a></div><p>By Martin, author of LocalJS</p>
<p>Quick jump link: </p>
<ul>
...
<dl class="note"><dt><b>Note:</b></dt><dd>JavaScript function refers variables defined out of the functon body by reference, which means when the function is defined, those variables do not have to be initialized; it's OK as long as when the function is called, those variables have been initialized.</dd></dl>
...
</pre></div><dl class="note"><dt><b>Note:</b></dt><dd>Functions saved to global variables are global functions, which also become properties of <a href="http://www.javascriptkit.com/jsref/window.shtml" target="_blank">JavaScript object window</a>, and can be accessed by <code>window.function_name</code>.</dd></dl>
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a> = {};
</pre></div><p>Functions, variable and sub namespace can be added as below:</p>
<div class="fragment"><pre class="fragment">    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.helper_doc = [<span class="stringliteral">&#39;Help1&#39;</span>, <span class="stringliteral">&#39;Help2&#39;</span>];
    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.helper_func = function(<span class="keywordtype">id</span>) { <span class="keywordflow">return</span> <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.helper_doc[id]; }

    <span class="comment">// a subnamespace:</span>
    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a> = {};
    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.doevents = function(){};
...
<div class="fragment"><pre class="fragment">    var ljs = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>,
        ui = ljs.ui,
...
</pre></div><div align="center"><em>Prev:</em> <a class="el" href="howto.php">How To ...</a> | <em>Next:</em> <a class="el" href="tutorials.php">JavaScript Tutorials</a> | <a class="el" href="index.php">Document Home</a></div> </div>
<hr class="footer"/>
