...
<title>LocalJS: UI Class Reference</title>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Move the window to foreground.  <a href="#ab4f615fc494a1630d85d58ca37deb01a"></a><br/></td></tr>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The <a class="el" href="interface_browser_window.php" title="Open source object. Represents a browser window. Returned by UI.newWindow. Include localjs_ui...">BrowserWindow</a> object for the new created browser window or standalone Internet Explorer.</dd></dl>
...
<div class="fragment"><pre class="fragment">    var browser_window = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.newWindow(<span class="stringliteral">&quot;http://myapp.com/&quot;</span>, 20, 30, 400, 300, <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.WS_NO_TITLE_BAR);
...
<div class="fragment"><pre class="fragment">    var funcInjected = function(new_jswindow)
    ...
    var browser_window = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.newWindow(<span class="stringliteral">&quot;http://myapp.com/&quot;</span>, 20, 30, 400, 300, <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.WS_NO_TITLE_BAR, <a class="code" href="interfacelocal_j_s.php" title="The root object of all advanced JavaScript objects. Available directly in JavaScript.">localJS</a>.<a class="code" href="interfacelocal_j_s.php#aa05066bf1c7f31ea898c0d2aed29eedb" title="ReadOnly. Returns the HWND handle of current browser window.">hostWnd</a>, funcInjected);
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.showTitleBar(<span class="keyword">true</span>);
</pre></div> 
</div>
</div>
...
<div class="fragment"><pre class="fragment">    document.title = <span class="stringliteral">&quot;New HTML Title&quot;</span>;
    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.updateTitle();
</pre></div> 
</div>
</div>
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.showTitleBar(<span class="keyword">true</span>);
    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.addDraggable(<span class="stringliteral">&#39;id_of_title_bar_element&#39;</span>, <span class="stringliteral">&#39;id_of_title_bar_element2&#39;</span>);
...
<dl class="note"><dt><b>Note:</b></dt><dd><a class="el" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">LOCALJS.UI</a> replaces standard JavaScript <code>alert</code> function with a call to LOCALJS.UI.msgBox with <em>error</em> set to <code>true</code>. </dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd><code>true</code> if user choosed "YES" or "OK", <code>false</code> if "NO" or "CANCEL" was chosen.</dd></dl>
<dl class="note"><dt><b>Note:</b></dt><dd><a class="el" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">LOCALJS.UI</a> replaces standard JavaScript <code>confirm</code> function with a call to LOCALJS.UI.msgBox with both <em>default_yes</em> and <em>ok_cancel</em> set to <code>false</code>. </dd></dl>
...
<p>Move the window to foreground. </p>
...
<div class="fragment"><pre class="fragment">    <span class="keywordflow">if</span> (news_comes)
        <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.bring2Top();
</pre></div> 
</div>
</div>
...
<div class="fragment"><pre class="fragment">    window.attachEvent(<span class="stringliteral">&quot;onload&quot;</span>, function()
    {
        <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.centerWindow(300, 180);
    });
</pre></div><p>You don't have to calculate the position of the new browser window in <a class="el" href="interface_u_i.php#a1affe0f3629c5b39d93ba05fd54fc3fc" title="Creates a new browser window or standalone Internet Explorer and navigates to given url...">UI.newWindow</a> method. It might be better to initialize the new browser window position at the page loaded by the created browser window with methods <a class="el" href="interface_u_i.php#a48bb86d6512ddef0a89997f6f26b28bb" title="Move current browser window to postion on screen specified by given parameters.">UI.moveWindow</a> or <a class="el" href="interface_u_i.php#a23574b724ef4f4142a333c96a2cc59df" title="Moves the browser window to the center of the screen, with width specified by cx and height specified...">UI.centerWindow</a>, in which case each browser window initializes themselves.</p>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_u_i.php#a1affe0f3629c5b39d93ba05fd54fc3fc" title="Creates a new browser window or standalone Internet Explorer and navigates to given url...">UI.newWindow</a> | <a class="el" href="interface_u_i.php#a48bb86d6512ddef0a89997f6f26b28bb" title="Move current browser window to postion on screen specified by given parameters.">UI.moveWindow</a> </dd></dl>
...
<div class="fragment"><pre class="fragment">    var rect = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.getWindowRect();
    var window_width = rect.right - rect.left;
    var window_height = rect.bottom - rect.top;
</pre></div><dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_structure.php" title="Structure object represents a C struct, used as parameters in Dll function call.">Structure</a> </dd></dl>
...
<div class="fragment"><pre class="fragment">    window.attachEvent(<span class="stringliteral">&quot;onload&quot;</span>, function()
    {
        <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.moveWindow(0, 0, 100, 50);
    }):
</pre></div><p>You don't have to calculate the position of the new browser window in <a class="el" href="interface_u_i.php#a1affe0f3629c5b39d93ba05fd54fc3fc" title="Creates a new browser window or standalone Internet Explorer and navigates to given url...">UI.newWindow</a> method. It might be better to initialize the new browser window position at the page loaded by the created browser window with methods <a class="el" href="interface_u_i.php#a48bb86d6512ddef0a89997f6f26b28bb" title="Move current browser window to postion on screen specified by given parameters.">UI.moveWindow</a> or <a class="el" href="interface_u_i.php#a23574b724ef4f4142a333c96a2cc59df" title="Moves the browser window to the center of the screen, with width specified by cx and height specified...">UI.centerWindow</a>, in which case each browser window initializes themselves.</p>
<dl class="note"><dt><b>Note:</b></dt><dd>If the current browser window is created as child window with window style WS_CHILD, then the position is relative to it's parent window, not to the screen. By default all browser window are not created as child window.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_u_i.php#a1affe0f3629c5b39d93ba05fd54fc3fc" title="Creates a new browser window or standalone Internet Explorer and navigates to given url...">UI.newWindow</a> | <a class="el" href="interface_u_i.php#a23574b724ef4f4142a333c96a2cc59df" title="Moves the browser window to the center of the screen, with width specified by cx and height specified...">UI.centerWindow</a> </dd></dl>
...
<div class="fragment"><pre class="fragment">    var SW_SHOWNA = 8,
        placement = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.getWindowPlacement(),
...
<dl class="return"><dt><b>Returns:</b></dt><dd><code>false</code> if the page is being unloaded or the process is shutting down, <code>true</code> otherwise.</dd></dl>
...
<div class="fragment"><pre class="fragment">    <span class="keywordflow">while</span> (!condition_is_ready)
    {
        <span class="keywordflow">if</span> (!<a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.doEvents())
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.exitCallback = function()
    {
        <span class="keywordflow">return</span> <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.confirm(<span class="stringliteral">&quot;Are you sure to exit?&quot;</span>);
    };
</pre></div><dl class="note"><dt><b>Note:</b></dt><dd><a class="el" href="interfacelocal_j_s.php#ae0a273e38f45d2547157ddb6cfa6108c" title="Close the current browser window. NOT available in standalone Internet Explorer application.">localJS.closeWindow</a> method won't trigger exitCallback.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interfacelocal_j_s.php#ae0a273e38f45d2547157ddb6cfa6108c" title="Close the current browser window. NOT available in standalone Internet Explorer application.">localJS.closeWindow</a> </dd></dl>
...
<div class="fragment"><pre class="fragment">    <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.newWindowCallback = function(disp, cancel, flags, url_context, url)
    {
        <span class="keywordflow">if</span> (ok_to_open_the_url)
        {
            var browser_obj = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a88c39a8606c41168abfe2e3d8d0198c9" title="Returns UI object, which provides methods for common UI operations. Include localjs_ui.js to use it.">UI</a>.newWindow(<span class="stringliteral">&quot;about:blank&quot;</span>);
...
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_u_i.php#a1affe0f3629c5b39d93ba05fd54fc3fc" title="Creates a new browser window or standalone Internet Explorer and navigates to given url...">UI.newWindow</a> | <a href="http://msdn.microsoft.com/en-us/library/ms632600(VS.85).aspx" target="_blank">Window Styles</a> </dd></dl>
...
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_browser_window.php#a862ffbf6976d63755adc1fc78f1a0354" title="Returns true if the BrowserWindow object refers to a standalone Internet Explorer, false for LocalJS browser window.">BrowserWindow.isIE</a> </dd></dl>
