...
<p><a href="class_l_o_c_a_l_i_z_a_t_i_o_n-members.php">List of all members.</a></p>
...
<div class="fragment"><pre class="fragment">    var localized_string = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="Return LOCALIZATION Object, which provides method for multi-languages support. Include localjs_locali...">LOCALIZATION</a>.get(<span class="stringliteral">&#39;year&#39;</span>); <span class="comment">// return &#39;年&#39; for langauge &#39;cn&#39;.</span>
...
<div class="fragment"><pre class="fragment">    var dt = <span class="keyword">new</span> Date();
    ...
    var localized_date = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="Return LOCALIZATION Object, which provides method for multi-languages support. Include localjs_locali...">LOCALIZATION</a>.get(<span class="stringliteral">&#39;formatDate&#39;</span>)(dt);
</pre></div> 
</div>
</div>
...
<div class="fragment"><pre class="fragment">    var user_lang = <a class="code" href="interface_l_o_c_a_l_j_s.php" title="The root object of all open source JavaScript objects. Need to include JavaScript files from LOCALJS ...">LOCALJS</a>.<a class="code" href="interface_l_o_c_a_l_j_s.php#a98bcca2bbefab54c92e47741132d25a9" title="Return LOCALIZATION Object, which provides method for multi-languages support. Include localjs_locali...">LOCALIZATION</a>.getAcceptLanguages(); <span class="comment">// return &#39;en-us,zh-CN;q=0.7,zh-HK;q=0.3&#39;</span>
</pre></div> 
</div>
</div>
</div>
