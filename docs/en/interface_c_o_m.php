...
<p><a href="class_c_o_m-members.php">List of all members.</a></p>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The COM object created</dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>Reference to the COM object</dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd><a class="el" href="interface_event_hook.php" title="Returned by method COM.connectEvents, used to disconnect COM event connected.">EventHook</a> object used to disconnect COM events if connected successfully. <code>false</code> otherwise.</dd></dl>
...
<dl class="note"><dt><b>Note:</b></dt><dd>Property <code>returnValue</code> is only available to COM event parameters being able to return value (parameters passed by reference by COM object), and when <em>event_parameters_return_value</em> is omitted or set to true.</dd></dl>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_event_hook.php" title="Returned by method COM.connectEvents, used to disconnect COM event connected.">EventHook</a> | webBrowser | <a href="http://msdn.microsoft.com/en-us/library/aa768337(VS.85).aspx" target="_blank">NewWindow3 Event</a> | <a href="http://msdn.microsoft.com/en-us/library/aa768329(VS.85).aspx" target="_blank">DocumentComplete Event</a> </dd></dl>
...
<dl class="return"><dt><b>Returns:</b></dt><dd>The object to be used in JavaScript</dd></dl>
