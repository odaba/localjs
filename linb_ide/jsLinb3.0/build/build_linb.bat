...
rem ==================
copy %relPath%jsLinb\js\linb.js /b + %relPath%jsLinb\js\Event.js /b + %relPath%jsLinb\js\CSS.js /b + %relPath%jsLinb\js\Dom.js /b  + %relPath%jsLinb\js\Template.js /b + %relPath%jsLinb\js\DragDrop.js /b+ %relPath%jsLinb\js\Cookies.js /b + %relPath%jsLinb\js\XML.js /b + %relPath%jsLinb\js\History.js /b + %relPath%jsLinb\js\Tips.js /b linb.js
