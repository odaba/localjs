...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Open source object. Provides methods for common file and registry operations. Include localjs_file.js, localjs_ui.js and localjs_webservice.js to use it.  <a href="interface_f_i_l_e.php#_details">更多...</a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">The root object of all LocalJS Basic objects. Need to include JavaScript files from LOCALJS Open Source Library to be available.  <a href="interface_l_o_c_a_l_j_s.php#_details">更多...</a><br/></td></tr>
