...
$doxygen_title = "LocalJS: More about LocalJS";
include_once($base_path.'/_include/common_header_part1.php');
?>
<title>LocalJS: More about LocalJS</title>
...
<div class="myli">LocalJS desktop application can be easily deployed from web</div> <div class="myli">LocalJS is very small, launch fast, and run fast</div> <div class="myli">LocalJS doesn't depend on anything else to run</div> <div class="myli">HTML/CSS/JavaScript is designed for easy to use, and easy to learn with <a href="http://www.javascriptkit.com/javatutors/" target="_blank">so many tutorials</a> on web</div> <div class="myli">Prototyping and developing in HTML/CSS/JavaScript are very fast and flexible</div> <div class="myli"><span class="red">FREE</span> JavaScript libraries like <a href="http://jQuery.com/" target="_blank">jQuery</a> make prototyping and programming in JavaScript even simpler</div> <div class="myli">JavaScript libraries like <a href="http://developer.yahoo.com/yui/" target="_blank">YUI</a> provide rich user interface controls for <span class="red">FREE</span></div><div class="big_separator"></div><h2><a class="anchor" id="localjs_safe"></a>
Is LocalJS safe?</h2>
