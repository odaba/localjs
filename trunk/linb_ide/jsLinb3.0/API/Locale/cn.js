    ...
    _.set(linb.Locale,["cn","doc","linb"], {
        ...
        request:{
            ...
            $paras:[
                ...
                "onSuccess [可选参数]: Function, 参数:[response Object, response type, threadid]. 当request成功时回调改函数.",
                "onFail [可选参数]: Function, 参数:[response Object, response type, threadid]. 当request失败时回调改函数.",
