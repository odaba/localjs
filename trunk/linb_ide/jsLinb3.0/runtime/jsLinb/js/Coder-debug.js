        ...
        */
        formatHTML:function(code, type, arrActions, fold, id, height){
            ...
            if(arrActions && arrActions[0]){
                ...
                aa.push("<span class='sh-toggle' href='javascript:;' onclick='linb.Coder._toggle(this);'>"
                    +(fold ? " + " : " - ")
        ...
        applyById:function(id, formatAll){
            var i = 0, self = this, fun = function(){
                if(linb.Dom.byId(id)){
                    ...
                    o = _.str.toDom(linb.Coder[formatAll ? "formatAll" : "formatHTML"](_t.text(), cls[0], cls[1]&& cls[1].split("-"), cls[2], id + ":" + i));
